  ...
  return (
    <div style={{ minHeight: '100vh', background: 'radial-gradient(1200px 600px at 78% -6%, #EEF3FF 0%, rgba(238,243,255,0) 60%), #F6F8FC' }}>
      ...
      <style>{`
        ...
        .hero-btns { display:flex; gap:13px; margin-bottom:26px; }
        .hero-badge { display:inline-flex; }
        .section-pad { padding:70px 26px 60px; }
        .feat-pad { padding:40px 26px 30px; }
        .uni-pad { padding:56px 26px 30px; }
        ...
        @media (max-width: 900px) {
          ...
          .section-pad { padding:50px 20px 40px; }
        }
        ...
        @media (max-width: 600px) {
          ...
          .section-pad { padding:40px 18px 32px; }
          .feat-pad { padding:32px 18px 24px; }
          .uni-pad { padding:40px 18px 24px; }
        }
      `}</style>
    </div>
  )
...
function HeroSection() {
  return (
    <section style={{ maxWidth: '1200px', margin: '0 auto' }} className="section-pad">
      <div className="hero-grid">
        <div style={{ animation: '0.7s cubic-bezier(0.2,0.7,0.2,1) 0s 1 normal both running fadeUp' }}>
          <div className="hero-badge" style={{ alignItems: 'center', gap: '9px', padding: '7px 14px', borderRadius: '999px', background: '#fff', border: '1px solid #E8ECF2', boxShadow: '0 2px 8px rgba(15,23,42,.04)', marginBottom: '24px' }}>
          ...
          <h1 className="hero-h1" style={{ lineHeight: 1.02, fontWeight: 800, letterSpacing: '-0.035em', margin: '0 0 22px', color: '#0F172A' }}>
          ...
          <p className="hero-p" style={{ lineHeight: 1.6, color: '#64748B', margin: '0 0 34px', maxWidth: '440px' }}>
        ...
        <div className="hero-mockup" style={{ position: 'relative', height: '530px', animation: '0.9s ease 0s 1 normal both running fadeIn' }}>
...
function FeaturesSection() {
  const features = [
    ...
    { title: 'Previous years bank', desc: 'Access past exam papers organized by year, type, batch, and lecture.', bg: '#FFF7ED', color: '#D97706', path: 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6 M8 13h8 M8 17h5' },
    ...
    { title: 'Works on all devices', desc: 'Seamless experience on desktop, tablet, and mobile.', bg: '#EFF6FF', color: '#0284C7', path: '' },
  ]
  return (
    <section style={{ maxWidth: '1200px', margin: '0 auto' }} className="feat-pad">
...
function UniversitiesSection({ universities }: { universities: University[] }) {
  return (
    <section id="universities" style={{ maxWidth: '1200px', margin: '0 auto' }} className="uni-pad">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(240px,1fr))', gap: '18px', maxWidth: '840px', margin: '0 auto' }}>
