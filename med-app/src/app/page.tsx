  ...
  return (
    <nav style={{
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '13px 26px', display: 'flex', alignItems: 'center', gap: '16px' }}>
        ...
        {/* Logo */}
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '11px', textDecoration: 'none', userSelect: 'none', cursor: 'pointer' }}>
        ...
        <div style={{ position: 'relative' }}>
          <button
            ...
            style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 14px', border: '1px solid #E8ECF2', background: '#fff', borderRadius: '11px', fontSize: '13px', fontWeight: 600, color: '#64748B', cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 1px 2px rgba(15,23,42,.03)', transition: 'border-color .15s' }}
          >
          ...
          {dropdownOpen && (
            <>
              ...
              <div style={{
                ...
                border: '1px solid #E8ECF2', borderRadius: '14px',
                  ...
                  <div style={{ padding: '6px', maxHeight: '260px', overflowY: 'auto' }}>
                    {universities.map((uni) => (
                      <button
                        ...
                        style={{ width: '100%', display: 'flex', alignItems: 'center', gap: '12px', padding: '10px 12px', borderRadius: '9px', border: 'none', background: 'transparent', cursor: 'pointer', fontFamily: 'inherit', fontSize: '13.5px', color: '#0F172A', textAlign: 'left', transition: 'background .15s' }}
        ...
        <Link
          href="/login"
          style={{ padding: '9px 18px', borderRadius: '11px', border: '1px solid #E8ECF2', background: '#fff', fontFamily: 'inherit', fontSize: '13.5px', fontWeight: 700, color: '#0F172A', textDecoration: 'none', transition: '0.18s' }}
        >
          Login
        </Link>
        <Link
          href="/register"
          style={{ padding: '9px 20px', borderRadius: '11px', border: 'none', background: 'linear-gradient(135deg,#2563EB,#4F46E5)', color: '#fff', fontFamily: 'inherit', fontSize: '13.5px', fontWeight: 700, textDecoration: 'none', boxShadow: '0 8px 20px -6px rgba(37,99,235,.6)', transition: '0.18s' }}
        >
          Register
        </Link>
      </div>
