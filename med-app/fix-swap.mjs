...
const page = `import { createClient as createServerClient } from '@/lib/supabase/server'
...
function HeroSection() {
  return (
    <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '70px 26px 60px', display: 'grid', gridTemplateColumns: '1.02fr 1.18fr', gap: '56px', alignItems: 'center' }}>
      <div style={{ animation: '0.7s cubic-bezier(0.2,0.7,0.2,1) 0s 1 normal both running fadeUp' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '9px', padding: '7px 14px', borderRadius: '999px', background: '#fff', border: '1px solid #E8ECF2', boxShadow: '0 2px 8px rgba(15,23,42,.04)', marginBottom: '24px' }}>
          <span style={{ display: 'flex', width: '7px', height: '7px', borderRadius: '50%', background: '#0EA5A4', boxShadow: '0 0 0 4px rgba(14,165,164,.16)', animation: '2.4s ease-in-out 0s infinite normal none running pulseDot' }} />
        ...
        <h1 style={{ fontSize: '59px', lineHeight: 1.02, fontWeight: 800, letterSpacing: '-0.035em', margin: '0 0 22px', color: '#0F172A' }}>
        ...
        <p style={{ fontSize: '17.5px', lineHeight: 1.6, color: '#64748B', margin: '0 0 34px', maxWidth: '440px' }}>
          Lectures, sheets, summaries, flashcards, quizzes, and previous years — every resource, structured around how you actually study.
        </p>
        <div style={{ display: 'flex', gap: '13px', marginBottom: '26px' }}>
          ...
          <Link href="/login" style={{ display: 'inline-flex', alignItems: 'center', padding: '15px 26px', borderRadius: '14px', border: '1px solid #E8ECF2', background: '#fff', color: '#0F172A', fontFamily: 'inherit', fontSize: '15px', fontWeight: 700, textDecoration: 'none' }}>
            Login
          </Link>
        </div>
      ...
      <div style={{ position: 'relative', height: '530px', animation: '0.9s ease 0s 1 normal both running fadeIn' }}>
        <div style={{ position: 'absolute', width: '300px', height: '300px', left: '8%', top: '2%', borderRadius: '50%', background: 'radial-gradient(circle,rgba(37,99,235,.28),transparent 68%)', filter: 'blur(12px)', animation: '11s ease-in-out 0s infinite normal none running drift' }} />
        <div style={{ position: 'absolute', width: '270px', height: '270px', right: '2%', bottom: 0, borderRadius: '50%', background: 'radial-gradient(circle,rgba(124,58,237,.24),transparent 68%)', filter: 'blur(12px)', animation: '13s ease-in-out 0s infinite normal none running drift2' }} />
        ...
        <div style={{ position: 'absolute', left: '1%', top: '3%', width: '98%', borderRadius: '16px', background: '#fff', border: '1px solid #E8ECF2', boxShadow: '0 46px 92px -34px rgba(15,23,42,.46),0 12px 32px -14px rgba(15,23,42,.16)', overflow: 'hidden', animation: '8.5s ease-in-out 0s infinite normal none running floatC', zIndex: 2 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '9px', padding: '9px 13px', borderBottom: '1px solid #E8ECF2', background: '#fff' }}>
            <div style={{ width: '26px', height: '26px', borderRadius: '8px', border: '1px solid #E8ECF2', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#64748B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M9 4v16"/></svg>
            </div>
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: '7px', background: '#F1F4F9', border: '1px solid #E8ECF2', borderRadius: '9px', padding: '6px 11px' }}>
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4-4"/></svg>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 138px' }}>
            <div style={{ padding: '14px 15px', background: '#fff' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '9px', color: '#94A3B8', marginBottom: '11px' }}>
                <span>Subjects</span><span>/</span><span>Pediatrics</span><span>/</span><span style={{ fontWeight: 700, color: '#0F172A' }}>Puberty and pubertal disorders</span>
              </div>
              <div style={{ borderRadius: '14px', background: 'linear-gradient(120deg,#EEF3FF,#F4F1FF)', border: '1px solid #E4E9F7', padding: '13px 14px', marginBottom: '13px' }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '11px' }}>
                  <div style={{ width: '34px', height: '34px', borderRadius: '10px', background: 'linear-gradient(135deg,#2563EB,#4F46E5)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '0 6px 14px -5px rgba(37,99,235,.6)' }}>
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/></svg>
                  </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', alignItems: 'flex-end', flexShrink: 0 }}>
                    <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontSize: '8.5px', fontWeight: 700, color: '#16A34A', background: '#ECFDF5', border: '1px solid #BBF7D0', borderRadius: '999px', padding: '3px 8px' }}>
                      <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17l-5-5"/></svg>Completed
                    </span>
                    <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontSize: '8.5px', fontWeight: 700, color: '#B45309', background: '#FEF9C3', border: '1px solid #FDE68A', borderRadius: '999px', padding: '3px 8px' }}>★ Free</span>
                  </div>
                </div>
              ...
              <div style={{ border: '1px solid #BBF7D0', background: '#F0FDF4', borderRadius: '10px', padding: '10px 12px' }}>
                ...
                <div style={{ fontSize: '9px', lineHeight: 1.55, color: '#166534' }}>
                  <b style={{ color: '#14532D' }}>Menarche</b> — the first menstrual period. <b style={{ color: '#14532D' }}>Thelarche</b> — onset of breast development.
                </div>
              </div>
            </div>
            <div style={{ padding: '12px 11px', background: '#FAFBFE', borderLeft: '1px solid #E8ECF2', display: 'flex', flexDirection: 'column', gap: '4px' }}>
              ...
              {[{label:'Sheet',active:true},{label:'Summary',active:false},{label:'Flashcards',active:false},{label:'Quiz',active:false},{label:'Previous Years',active:false}].map((item) => (
                <div key={item.label} style={{ display: 'flex', alignItems: 'center', gap: '7px', padding: '7px 8px', borderRadius: '8px', background: item.active ? '#EAF1FE' : 'transparent', border: item.active ? '1px solid #C7D9FB' : '1px solid transparent' }}>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke={item.active ? '#2563EB' : '#94A3B8'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/></svg>
                  <span style={{ flex: 1, fontSize: '9.5px', fontWeight: item.active ? 700 : 600, color: item.active ? '#2563EB' : '#475569' }}>{item.label}</span>
                  {item.active && <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#2563EB" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M9 6l6 6-6 6"/></svg>}
                </div>
              ))}
        ...
        <div style={{ position: 'absolute', right: '1%', top: '2%', width: '186px', borderRadius: '16px', background: '#fff', border: '1px solid #E8ECF2', boxShadow: '0 26px 50px -20px rgba(37,99,235,.4)', padding: '15px', animation: '6.5s ease-in-out 0s infinite normal none running floatB', zIndex: 3 }}>
        ...
        <div style={{ position: 'absolute', right: '8%', bottom: '15%', display: 'flex', alignItems: 'center', gap: '9px', padding: '11px 15px', borderRadius: '14px', background: 'linear-gradient(135deg,#0EA5A4,#0891B2)', boxShadow: '0 20px 40px -16px rgba(14,165,164,.6)', animation: '5.5s ease-in-out 0.4s infinite normal none running floatC', zIndex: 5 }}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17l-5-5"/></svg>
          <div>
...
function FeaturesSection() {
  const features = [
    { title: 'Organized by subject', desc: 'Content grouped into structured academic subjects per university.', bg: '#EEF2FF', color: '#4F46E5', path: 'M12 2L2 7l10 5 10-5-10-5z M2 17l10 5 10-5 M2 12l10 5 10-5' },
    { title: 'Progress tracking', desc: 'Track completed lectures and monitor your learning progress visually.', bg: '#ECFDF5', color: '#16A34A', path: 'M3 3v18h18 M7 14l4-4 3 3 5-6' },
    { title: 'Bookmarks & notes', desc: 'Save important content and add personal notes — private to you.', bg: '#FDF4FF', color: '#9333EA', path: 'M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z' },
    { title: 'Previous years bank', desc: 'Access past exam papers organized by year, type, batch, and lecture.', bg: '#FFF7ED', color: '#D97706', path: 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6 M8 13h8M8 17h5' },
    { title: 'Clinical resources', desc: 'OSCE cases, checklists, and oral exam prep for clinical students.', bg: '#FEF2F2', color: '#DC2626', path: 'M20.8 5.6a5.5 5.5 0 0 0-7.8 0L12 6.6l-1-1a5.5 5.5 0 1 0-7.8 7.8l1 1L12 22l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8z' },
    { title: 'Works on all devices', desc: 'Seamless experience on desktop, tablet, and mobile.', bg: '#EFF6FF', color: '#0284C7', path: 'M0 0' },
  ]
  return (
    <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 26px 30px' }}>
      <div style={{ textAlign: 'center', marginBottom: '44px' }}>
        ...
        <h2 style={{ fontSize: '38px', fontWeight: 800, letterSpacing: '-0.03em', margin: '0 0 12px', color: '#0F172A' }}>Everything organized around learning</h2>
        <p style={{ fontSize: '16px', color: '#64748B', margin: 0 }}>One structured academic platform — not a marketplace.</p>
      </div>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '18px' }}>
        {features.map((f) => (
          <div key={f.title} style={{ position: 'relative', background: '#fff', border: '1px solid #E8ECF2', borderRadius: '18px', padding: '26px 24px', overflow: 'hidden' }}>
            <div style={{ width: '46px', height: '46px', borderRadius: '13px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px', background: f.bg, color: f.color }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                {f.title === 'Works on all devices'
                  ? <><rect x="5" y="2" width="14" height="20" rx="2.5"/><path d="M11 18h2"/></>
                  : f.path.split(' M').filter(Boolean).map((p,i) => <path key={i} d={i===0?'M'+p:'M'+p}/>)
                }
              </svg>
            </div>
            <h3 style={{ fontSize: '16.5px', fontWeight: 700, margin: '0 0 8px', letterSpacing: '-0.01em', color: '#0F172A' }}>{f.title}</h3>
            <p style={{ fontSize: '13.5px', lineHeight: 1.55, color: '#64748B', margin: 0 }}>{f.desc}</p>
            <div style={{ position: 'absolute', right: '-30px', bottom: '-30px', width: '90px', height: '90px', borderRadius: '50%', background: f.bg, opacity: 0.5, filter: 'blur(8px)' }} />
          </div>
        ))}
      </div>
    </section>
...
function UniversitiesSection({ universities }: { universities: University[] }) {
  return (
    <section id="universities" style={{ maxWidth: '1200px', margin: '0 auto', padding: '56px 26px 30px' }}>
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        <h2 style={{ fontSize: '34px', fontWeight: 800, letterSpacing: '-0.03em', margin: '0 0 10px', color: '#0F172A' }}>Available universities</h2>
        <p style={{ fontSize: '15.5px', color: '#64748B', margin: 0 }}>Select your institution and access its organized educational resources.</p>
      </div>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(260px,1fr))', gap: '18px', maxWidth: '840px', margin: '0 auto' }}>
              ...
              <div style={{ background: '#fff', border: '1px solid #E8ECF2', borderRadius: '18px', padding: '28px 24px 20px', textAlign: 'center', cursor: 'pointer' }}>
                <div style={{ width: '74px', height: '74px', borderRadius: '50%', margin: '0 auto 16px', background: 'linear-gradient(135deg,#EEF2FF,#F5F3FF)', border: '1px solid #E8ECF2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  {uni.logo_url
                    ...
                    : <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="#2563EB" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M22 10L12 5 2 10l10 5 10-5z"/><path d="M6 12v5c0 1 2.5 2.5 6 2.5s6-1.5 6-2.5v-5"/></svg>
                  }
                </div>
        ...
        <div style={{ border: '1.5px dashed #CBD5E1', borderRadius: '18px', padding: '28px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', color: '#94A3B8' }}>
          <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: '#F1F5F9', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '12px' }}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14"/><path d="M5 12h14"/></svg>
          </div>
    ...
    <footer style={{ marginTop: '64px', background: 'linear-gradient(120deg,#0D1B2A,#12223A)' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '34px 26px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '20px', flexWrap: 'wrap' as const }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '11px' }}>
          <svg width="30" height="30" viewBox="0 0 48 48" fill="none"><circle cx="24" cy="24" r="16" stroke="#CFE0F5" strokeWidth="2.6"/><path d="M5 24 H16 l2 -5 l3 10 l2 -5 H43" stroke="#CFE0F5" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"/><path d="M24 6 V24" stroke="#CFE0F5" strokeWidth="2.6" strokeLinecap="round"/><path d="M24 24 V42" stroke="#5AA0FF" strokeWidth="2.6" strokeLinecap="round"/></svg>
...
export default function LandingNavbar({ universities }: LandingNavbarProps) {
  ...
  return (
    <nav style={{ position: 'sticky', top: 0, zIndex: 60, background: 'rgba(246,248,252,0.82)', backdropFilter: 'blur(14px)', borderBottom: '1px solid #E8ECF2' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '13px 26px', display: 'flex', alignItems: 'center', gap: '16px' }}>
...
writeFileSync('src/app/page.tsx', page, 'utf8')
writeFileSync('src/components/student/LandingNavbar.tsx', navbar, 'utf8')

console.log('page.tsx lines:', page.split('\n').length)
console.log('LandingNavbar.tsx lines:', navbar.split('\n').length)
console.log('done')