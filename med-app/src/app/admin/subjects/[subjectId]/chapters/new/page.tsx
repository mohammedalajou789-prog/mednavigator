  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
        ...
        <span>/</span>
        <span className="text-gray-900 font-medium">New Chapter</span>
      </nav>
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 mt-3">Add New Chapter</h1>
        <p className="text-sm text-gray-500 mt-1">
          Chapters organise lectures inside a subject. Create the chapter first, then add lectures inside it.
        </p>
      </div>

      <AddChapterForm subjectId={subjectId} />
    </div>
  )
}