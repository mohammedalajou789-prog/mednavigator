...
const STEPS = ['Complete the payment', 'Send proof via WhatsApp', 'Your subscription will be activated']
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '420px', padding: '48px 24px', textAlign: 'center' }}>
      ...
      <button
        ...
        style={{ marginTop: '20px', display: 'inline-flex', alignItems: 'center', gap: '8px', height: '42px', padding: '0 20px', borderRadius: '11px', background: '#25D366', color: '#fff', fontSize: '14px', fontWeight: 700, border: 'none', cursor: 'pointer', fontFamily: 'inherit' }}
      >
